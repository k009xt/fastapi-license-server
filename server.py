...
# ====== Íàñòðîéêè ======
API_KEY = "SUPER_SECRET_ADMIN_KEY_12345"  # Êëþ÷ äëÿ àäìèíñêèõ îïåðàöèé
LICENSE_DAYS = 30  # Ñðîê äåéñòâèÿ ëèöåíçèè
GRACE_DAYS = 5     # Ïåðèîä îæèäàíèÿ ïîñëå îêîí÷àíèÿ

# Ïîäêëþ÷åíèå ê Google Sheets
SERVICE_ACCOUNT_FILE = "licenseserver-468712-9457b67a044f.json"  # Ôàéë ñ òâîèìè äàííûìè
SPREADSHEET_NAME = "licenses"                  # Èìÿ òàáëèöû
SHEET = None
